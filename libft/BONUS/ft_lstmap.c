...
/*   Updated: 2024/06/29 20:42:00 by hbourlot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

/// @brief Iterates the linked list 'lst' and applies the function 'f' to each element.
///        Uses function 'del' to delete the element if the memory allocation fails.
