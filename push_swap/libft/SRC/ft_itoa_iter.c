...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/09 23:47:47 by hbourlot          #+#    #+#             */
/*   Updated: 2024/07/09 23:48:11 by hbourlot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_nbrlen1(long nbr)
{
	if (nbr < 0)
		return (ft_nbrlen1(-nbr) + 1);
	if (nbr > 9)
		return (ft_nbrlen1(nbr / 10) + 1);
	return (1);
}
